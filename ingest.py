import os
# 🚀 ახალი იმპორტი .env ფაილის ჩასატვირთად
...
# ----------------------------------------------------
# 1. 🔑 .env ფაილის ჩატვირთვა (გასაღებების დასამალად)
# ----------------------------------------------------
# ეს ფუნქცია ეძებს .env ფაილს მიმდინარე საქაღალდეში და ტვირთავს ცვლადებს os.environ-ში
load_dotenv() 
...
# ----------------------------------------------------
# 2. 🔑 გასაღების უსაფრთხოდ წაკითხვა
# ----------------------------------------------------
...
# API გასაღების დაყენება Langchain-ის გამოყენებისთვის
if OPENAI_API_KEY:
...
def ingest_data():
    ...
    # ეს ხაზი ქმნის და ინახავს ChromaDB-ს CHROMA_PATH-ში ("chroma_db")
