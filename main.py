...
# 📢 აუცილებელი იმპორტი სტატიკური ფაილებისთვის
...
# ----------------------------------------------------------------------------------
# 📢 ლოკალური გაშვების ლოგიკა (if __name__ == "__main__":) ამოღებულია, რათა 
# არ მოხდეს კონფლიქტი Render-ის პორტის კონფიგურაციასთან.
# ----------------------------------------------------------------------------------
